...
export default function Home() {
  return (
    <HomeLayout>
      <div className='flex flex-col gap-6 xl:my-20 mb-20 mt-10'>
        <div className='flex flex-col lg:flex-row gap-6 w-full justify-around items-center'>
         <div className='flex flex-col justify-center items-center gap-4'>
          <h1 className='text-4xl xl:text-7xl font-bold flex flex-col text-white'>
          ...
          <p className='text-sm font-sans text-slate-50 flex flex-col xl:text-3xl'>I help you increase conversion and performance<span> in every possible way</span></p>
          ...
          <img src={img} className='h-[60vh] w-[60vh] rounded-tl-full rounded-bl-full rounded-br-full'/>
          </div>
        </div>
